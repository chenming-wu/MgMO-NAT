...
# Training
gpu=0
CUDA_VISIBLE_DEVICES=$gpu python $RUN/fairseq_cli/train.py  $DATA  --save-dir $MODEL  --tensorboard-logdir $MODEL/tb --eval-tokenized-bleu \
